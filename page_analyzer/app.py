...
def url_detail(id):
    ...
    :return: Шаблон url_detail.html с данными URL
     и проверками или сообщение об ошибке.
    """
...
def check_url(id):
    ...
    :return: Перенаправление на страницу с деталями URL
     или на список URL в случае ошибки.
    """
    url = get_url_name(id)
    if url is None:
        flash('URL не найден', 'danger')
